...
class GallerySaverClass extends StatefulWidget {
  @override
  _GallerySaverClassState createState() => _GallerySaverClassState();
}

class _GallerySaverClassState extends State<GallerySaverClass> {
